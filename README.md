...
Agentic Config Kit, or ACK, helps a repo share AI assistant setup across tools.
You write rules, commands, skills, and agents once. ACK creates the files that
Claude Code, Cursor, Windsurf/Devin, Codex, and Continue expect.
...
Want to try ACK in a disposable repo first?
...
| I want an AI assistant to do this for me | Use the prompt below | Gives your assistant a safe setup checklist. |
